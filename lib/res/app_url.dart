class AppUrl{
  ...
  static var acceptOrRejectConnectionRequest = baseUrl+'connections/accept-reject';
  ...
  static var markAllNotificationAsRead = baseUrl+'notifications/all/mark-as-read';
