...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String _selectedPrivacy = 'global';
  ...
  Widget build(BuildContext context) {
                ...
                children: <Widget>[
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ShowPostCard(post[index]);
                      }),
                  _showMoreBtn,
                ],
              ),
    ...
    return Container(color: Constants.np_bg_clr, child: _child);
  }

  Widget _defaultHomePage(String? text) {
